            ...
            <div class="wrap">
                ...
                <div class="secciones">
                    ...
                    <article id="tab3">
                        ...
                        <div class="socials">
                            <div class="insta"><a href="#"><i class="fab fa-instagram icon"></i></a></div>
                            <div class="face"><a href="#"><i class="fab fa-facebook icon"></i></a></div>
                            <div class="mail"><a href="#"><i class="far fa-envelope icon"></i></a></div>
                            <!--NO de momento lo de wh-->
                            <!--<div class="cel"><a href="#"><i class="fab fa-whatsapp icon"></i>2942-123456</a></div-->
                            <div class="cel"><a href="#"><i class="fab fa-whatsapp icon"></i></a></div>
                            <div class="tele"><a href="#"><i class="fab fa-telegram icon"></i></a></div>
                        </div>
                    </article>
                    <article id="tab4">
                        <h1>Galeria</h1>
